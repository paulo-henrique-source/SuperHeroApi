          ...
          onClick={() => {
            Swal.fire({
              ...
              html:
                ...
                '</label>' +
                '<br/>' +
                '<label className="swal-label">Power: ' +
                hero[i]['powerstats']['intelligence'] +
                '</label>' +
                '<br/>' +
                '<label className="swal-label">Work: ' +
                hero[i]['work']['base'] +
                '</label>' +
                '<br/>' +
                '<label className="swal-label">Appearance: ' +
                hero[i]['appearance']['gender'] +
                '</label>' +
                '<br/>' +
                '<label className="swal-label">Biography: ' +
                hero[i]['biography']['full-name'] +
                '</label>' +
                '<br/>' +
                '<label className="swal-label">Connections: ' +
                hero[i]['connections']['group-affiliation'] +
                '</label> ' +
                '<br/>' +
                '</ul>',
            })
  ...
  if (hero != []) {
    return (
      <Fragment>
        ...
        {featuredData && <FeaturedHero item={featuredData} />}
        ...
        <div className="container">
          ...
          >
            ...
            <div
              id="heroesArrow--right"
              className="heroesRow--right"
